...
class T(unittest.TestCase):
 def test_sources(self): self.assertEqual(len(newsroom.load(ROOT/'newsroom/sources.json')['sources']),10)
 ...
 def test_risk(self): self.assertIn('decedat',newsroom.risk('un bărbat decedat',newsroom.load(ROOT/'newsroom/policy.json')))
